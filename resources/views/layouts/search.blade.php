<form action="/search" method="get" class="mt-2">
    <div class="row bg-light py-2 round-off">
        <div class="col-8 col-lg-10">
            <input type="search" name="q" class="form-control form-control-lg w-100 border-0" placeholder="Search by program, institution or any other keywords..." value="{{ $query ?? '' }}" required>
        </div>
